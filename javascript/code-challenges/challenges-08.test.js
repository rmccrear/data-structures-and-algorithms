...
const sortByChildren = (charArray) => {
  // Solution code here...
  const numberOfChildren = (fam) => fam.children.length;
  const compareChildren = (a, b) => numberOfChildren(a) - numberOfChildren(b);
  const compareHouses = (a, b) => a.house.localeCompare(b.house);
  const sorter = (a, b) => {
      const c1 = compareChildren(a, b);
      if(c1 === 0){
...
const isCapitalized = (str) => {
  // Solution code here...
  const result =  str.match(/[A-Z]\w{0,}/g)

...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((sum, item) => sum+item.purchasePrice, 0);
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((sum, elm)=>sum+1,0);
};
...
const reversedString = (str) => {
  // Solution code here...
  return Array.from(str).reduce((str2, letter)=> letter+str2,'')
};
